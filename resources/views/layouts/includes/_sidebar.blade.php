 ...
 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="boissons" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
                <a class="collapse-item" href="{{route('admin.drinks')}}">Liste</a>
                <a class="collapse-item" href="{{route('admin.drinks.create')}}">Ajouter</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="commandes" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
                <a class="collapse-item" href="{{route('admin.commandes')}}">Liste</a>
                <a class="collapse-item" href="{{route('admin.commandes.create')}}">Ajouter</a>
            </div>
        </div>
    </li>
    <!-- Factures -->
    <li class="nav-item">
        ...
        <div id="factures" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
                <a class="collapse-item" href="{{route('admin.clients')}}">Liste</a>
                <a class="collapse-item" href="{{route('admin.clients.create')}}">Ajouter</a>
            </div>
        </div>
    </li>
</ul>
